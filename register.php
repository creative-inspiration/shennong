...
<table style="width: 100%;height:100%;" >
  <tr>
    <td align="center" >
      ...
      <table  align="center" width=350 height=230; style="font-family:微软雅黑;font-size:25px;">
      <tr align="center"> 
          <td colspan="2" style="font-size:35px; color: white;font-weight:700">注册用户</td>
      </tr>
      <tr>
          <td align="center" style="color: white;font-weight:700">用户名</td>
          <td>
          <input type="name" maxlength="20" name="id" placeholder="手机号/邮箱" style="width:180px;font-size:20px;border-radius: 8px; ">
          </td>
      </tr>
      <tr>
          <td align="center" style="color: white;font-weight:700">密   码</td>
          <td >
          <input name="password" type="password" maxlength="16" placeholder="请输入密码" style="width:180px;font-size:20px;border-radius: 8px; ">
      </td>
      </tr>
      <tr>
          <td align="center"style="color: white;font-weight:700">Again</td>
          <td>
